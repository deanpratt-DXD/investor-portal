// Scene: Regional VA overview map — real geography, pan/zoom, site icons.
// 3 Asset Owner sites, all within the regional metro. Pan with drag, zoom with
...
function MapScene({ onZoomToSite }) {
  ...
  return (
    <section className="scene" data-screen-label="03 Regional Sites" style={{padding: '120px 0'}}>
      <div style={{width: '100%', position: 'relative'}}>
        <div className="ctx-wrap" style={{marginBottom: 40}}>
          <div className="eyebrow">Deployment · Regional Metro</div>
          <h2 className="display" style={{marginTop: 16, maxWidth: '22ch'}}>
            Three Regional sites. One unified airspace picture.
          </h2>
          <p className="lead" style={{marginTop: 24}}>
            DXD proposes a phased deployment across three of the highest-value
            assets in the portfolio — from the downtown distribution hub feeding the civic/government core
            to the 500 kV generation complex on the river. A drone crossing any site is
        ...
        <div
          ...
          <svg viewBox={`0 0 ${BASE_W} ${BASE_H}`} preserveAspectRatio="xMidYMid slice"
            ...
            <g transform={viewTransform}>
              {/* the river — follows approximate Regional course: NW→SE through downtown,
                  then sweeps SE out toward Site Alpha.  Rendered wide + soft. */}
              <g opacity="0.55">
              ...
              {/* City of Regional boundary — rough shape */}
              ...
              <g fontFamily="var(--font-mono)" fontSize="10" fill="var(--dxd-silver)"
                ...
                <text x="450" y="260" fill="rgba(255,255,255,0.5)" fontSize="11"
                      letterSpacing="0.3em">REGION</text>
                <text x="715" y="450" fill="rgba(200,16,46,0.55)">COUNTY A</text>
                <text x="570" y="160" fill="rgba(200,16,46,0.55)">COUNTY B</text>
                <text x="200" y="420" fill="rgba(200,16,46,0.45)">COUNTY C</text>
                <text x="320" y="300" fill="rgba(37,99,235,0.75)" fontStyle="italic"
                      fontSize="9">the river</text>
          ...
          <div style={{position: 'absolute', top: 16, left: 20, zIndex: 4,
            ...
            Regional Metro · 37.3°–37.7°N · WGS-84 · DXD-CUAS-REGION-01
          </div>
          ...
          <div className="map-legend">
            ...
            <div className="item">
              ...
              <span>Critical-Infrastructure Site (DXD deployment)</span>
            </div>
            <div className="item">
            ...
            <div className="item">
              ...
              <span>the river / tributaries</span>
            </div>
            <div className="item">
