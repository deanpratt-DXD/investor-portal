...
window.SENSORS = {
  ...
  c2: {
    ...
    fns: [
      ...
      'Direct tie-in to site SCADA / compliance reporting',
      'Automated federal, state & local agency notification',
...
// 3 representative critical-infrastructure sites within a regional metro.
// Generic names — no utility or locality attribution. Map coords are illustrative.
// mapX/mapY are percentages into the SVG frame (see scenes-map.jsx).
window.SITES = [
  {
    id: 'chesterfield',
    name: 'Site Alpha — Generation Complex',
    type: 'Generation + 230 kV Switchyard',
    voltage: '230 / 115 kV',
    lat: 37.3832, lng: -77.3821,
    coord: '37.3832°N · 77.3821°W',
    locality: 'Southern metro · riverfront',
    priority: 'TIER-1',
    acreage: '1,200 ac',
    threats: 17,
    notes: 'Largest generation complex in the portfolio; river frontage, rural approach vectors.',
    metersPerUnit: 4.0,
    mapZoomTight: 16.2,
    mapZoomWide: 13.5,
    mapBearing: -15,
  ...
  {
    id: 'twelfth',
    name: 'Site Bravo — Downtown Distribution Hub',
    type: 'Downtown Distribution Hub',
    voltage: '115 / 34.5 kV',
    lat: 37.5396, lng: -77.4300,
    coord: '37.5396°N · 77.4300°W',
    locality: 'Urban core · CBD-adjacent',
    priority: 'TIER-1',
    acreage: '2.1 ac',
    threats: 11,
    notes: 'Feeds CBD, state/municipal seat, hospital systems; dense urban RF environment.',
    metersPerUnit: 1.4,
    mapZoomTight: 17.6,
    mapZoomWide: 14.5,
    mapBearing: 20,
  ...
  {
    id: 'lakeside',
    name: 'Site Charlie — Transmission Switching',
    type: 'Transmission Switching',
    voltage: '230 / 115 kV',
    lat: 37.6250, lng: -77.4748,
    coord: '37.6250°N · 77.4748°W',
    locality: 'Northern metro · interstate-adjacent',
    priority: 'TIER-2',
    acreage: '64 ac',
    threats: 6,
    notes: 'Key north-side transmission node; high-speed corridor approach.',
    metersPerUnit: 2.8,
    mapZoomTight: 16.4,
    mapZoomWide: 13.8,
    mapBearing: 0,
...
// =====================================================================
// LIVE SCENARIO — rogue drone incident at Site Alpha.
...
window.FEDERATION_CHANNELS = [
  // Federal
  { id: 'fbi',    tier: 'FED',   agency: 'FBI',              unit: 'WMD Directorate · Local Field Office',    channel: 'eGuardian · TS/SCI' },
  ...
  // State
  { id: 'vafc',   tier: 'STATE', agency: 'State Fusion Ctr.',unit: 'Critical Infrastructure desk',            channel: 'RISSNET · Fusion SAR' },
  { id: 'vsp',    tier: 'STATE', agency: 'State Police',     unit: 'Criminal Investigation · CI Unit',        channel: 'State CIN · encrypted radio' },
  { id: 'veoc',   tier: 'STATE', agency: 'State EOC',        unit: 'Emergency Operations Center',             channel: 'WebEOC' },
  // Local
  { id: 'ccso',   tier: 'LOCAL', agency: 'County Sheriff',   unit: 'Patrol + CID',                            channel: 'CAD · MDT dispatch' },
  { id: 'cc911',  tier: 'LOCAL', agency: 'County E911',      unit: 'Emergency Communications · PSAP',         channel: 'E911 CAD integration' },
  // Utility / reliability
  { id: 'dsoc',   tier: 'UTIL',  agency: 'Asset Owner SOC',  unit: 'Security Operations Center',              channel: 'SOC · SCADA tie-in' },
  { id: 'eisac',  tier: 'UTIL',  agency: 'Sector ISAC',      unit: 'Sector Information Sharing · Analysis',   channel: 'ISAC portal' },
  { id: 'pjm',    tier: 'UTIL',  agency: 'Reliability Coord.',unit: 'Reliability Coordinator · Security desk', channel: 'RC secure feed' },
];
...
window.SCENARIO_STEPS = [
  {
    ...
    caption: 'All perimeter sensors online. No tracks. Weather CAVOK. Airspace clear per FAA DEN. Asset-owner SOC shift change at 06:00 — DXD watch standing.',
    alertLevel: 'nominal',
    ...
    channelsFired: [],
    logLines: [
      { t: 'T+00:00:00', sys: 'DXD-AEGIS', type: 'info', msg: 'Watch on. Site Alpha sector nominal. 21 sensors online. Coverage 100%.' },
      { t: 'T-00:04:12', sys: 'WX',        type: 'info', msg: 'METAR 060654Z VRB03KT 10SM FEW250 06/M02 A3012 — flight conditions CAVOK.' },
    ],
  },
  {
  ...
  },
  {
    ...
    caption: 'DF-01 and DF-02 compute operator bearing. TDOA fusion fixes the pilot across the river on a public boat launch. Pilot marker drops on overview map with ±22 m CEP.',
    alertLevel: 'amber',
    droneT: 0.36,
    pilotShown: true,
    ...
    logLines: [
      ...
      { t: 'T+00:00:20', sys: 'DXD-AEGIS', type: 'warn', msg: 'Pilot fix · 37.3876°N 77.3724°W · ±22 m CEP · Public boat launch · public access' },
    ],
  },
  {
  ...
  },
  {
    ...
    caption: 'County Sheriff units staged from the far-bank side. DXD on-site security moves to hardened posture. FAA files emergency TFR request to clear the block. Asset-owner SOC assumes joint watch.',
    alertLevel: 'red',
    droneT: 0.66,
    pilotShown: true,
    ...
    logLines: [
      { t: 'T+00:00:34', sys: 'SHERIFF',      type: 'info', msg: 'Two patrol units dispatched · far-bank side · ETA 4 min · CAD Inc #2026-CI-0173' },
  ...
  },
  {
    ...
    logLines: [
      ...
      { t: 'T+00:00:46', sys: 'FAA-DEN',    type: 'info', msg: 'TFR granted · 1 NM / SFC-400 AGL · letter of agreement CI-LOA-04 active' },
    ],
  },
  {
    step: 7, t: 'T+00:00:58', label: 'SHADOW + HAIL',
    title: 'Interceptor shadowing · two-way hail opened',
    caption: 'DXD-AIR-01 pulls into a 40 m trail on UAS-01 and holds station. Operator broadcasts a two-way hail on the rogue\'s command channel (DJI AeroScope-seeded RID bridge) and over 121.5 MHz guard: "Unknown UAS operating over critical infrastructure — you are in restricted airspace under FAA TFR. Land immediately. Law enforcement is en route to your position at far-bank." Response teams pinged in parallel.',
    alertLevel: 'red',
    droneT: 0.80,
    interceptT: 0.55,
    interceptShown: true,
    ...
    comms: [
      ...
      { from: 'DXD-AIR-01', role: 'HAIL · RID BRIDGE + 121.5', side: 'hail',  t: 'T+00:01:02', msg: 'Unknown UAS over critical infrastructure — restricted airspace under active FAA TFR. Land immediately and remain with your aircraft. County Sheriff is en route.' },
      { from: 'DXD-OPS',    role: 'TEAM PAGE · SHERIFF + DXD GROUND', side: 'page', t: 'T+00:01:03', msg: 'SITREP to Sheriff Patrol-1, Patrol-2, DXD ground team 3 · operator @ public boat launch · ±22 m · grey sedan suspect vehicle.' },
    ],
    logLines: [
      ...
      { t: 'T+00:01:03', sys: 'DXD-OPS',    type: 'info', msg: 'Response teams paged · Sheriff Patrol-1/2 · DXD Ground-3 · ETA sheriff 90s' },
    ],
  },
  {
  ...
  },
  {
    ...
    caption: 'UAS-01 touches down at 37.3876°N 77.3724°W. Sheriff Patrol-1 arrives 22 seconds later; operator is cooperative, detained pending charging decision by the local prosecuting authority. DXD-AIR-01 RTB. C2 seals the evidence bundle — video, audio, telemetry, DF, federation receipts — for prosecution and sector incident-reporting.',
    alertLevel: 'resolved',
    droneT: 1.00,
    interceptT: 1.00,
    interceptShown: true,
    ...
    commsShown: true,
    comms: [
      { from: 'SHERIFF-1', role: 'COUNTY SHERIFF', side: 'le', t: 'T+00:02:07', msg: 'On scene public boat launch · subject cooperative · aircraft secured · starting interview.' },
      { from: 'DXD-AIR-01', role: 'DXD OPERATOR', side: 'ops', t: 'T+00:02:09', msg: 'RTB · mission recorder sealed · handing scene to Sheriff and FBI.' },
    ],
    logLines: [
      { t: 'T+00:02:07', sys: 'SHERIFF-1',     type: 'ok',   msg: 'On scene · operator detained · no resistance · UAS-01 secured' },
      { t: 'T+00:02:12', sys: 'CoC',        type: 'ok',   msg: 'Evidence bundle sealed · INC-2026-CI-0173 · SHA-256 committed' },
      { t: 'T+00:02:15', sys: 'DXD-AEGIS',  type: 'ok',   msg: 'Incident closed on airspace · sector incident report staged · no damage to assets · watch resumes nominal' },
    ],
  },
];

// Drone flight path — polyline of [lng, lat] points, relative to Site Alpha.
...
(function(){
  ...
  // Pilot location — across the river at a public boat launch
  window.SCENARIO_PILOT = [-77.3724, 37.3876];
  // Sheriff staging origin (Courts & Jail complex)
