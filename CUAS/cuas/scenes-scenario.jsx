// Live Scenario — rogue drone incident at Site Alpha, told in 8 scroll
...
function ScenarioScene({ tweaks, refCb }) {
  ...
  // Site Alpha site for map anchoring.
  const site = useMemo(
  ...
  useEffect(() => {
    ...
    map.on('load', () => {
      ...
      // Perimeter polygon (Site Alpha fence line)
      try {
  ...
  useEffect(() => {
    ...
    //   Step 5+:   pull back to reveal the the river + pilot across water
      ...
      <div ref={stickyRef} style={{ height: '100%' }}>
        <div className="sticky-inner scn-stage">
          ...
          <div className="scene-label">
            <span className="red">SCENE 04</span> · Live Scenario · Site Alpha · INC-2026-CI-0173
          </div>
          ...
          <aside className="scn-c2">
                ...
                <div className="t-rows">
                  ...
                  <div><span>Operator</span>
                    <b className={current.pilotShown ? 'red' : ''}>
                      {current.pilotShown ? '1.8 km NNW · far-bank' : step >= 1 ? 'ISOLATING…' : '—'}
                    </b>
                  </div>
            ...
            <div className="c2-sensors">
              <div className="s-hd">ON-SITE SENSOR GRID · SITE ALPHA</div>
            ...
            <div className="c2-log">
              <div className="l-hd">
                ...
                <span className="inc">INC-2026-CI-0173</span>
              </div>
