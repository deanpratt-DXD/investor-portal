...
function ScenarioScene({ tweaks, refCb }) {
  ...
  const script = useMemo(() => [
    ...
    { t: 'T+00:18', sys: 'SOC',     type: 'info', msg: 'Dispatch · Chesterfield County PD to operator fix' },
    ...
    { t: 'T+00:53', sys: 'DOMINION', type: 'ok',  msg: 'Dominion SOC notified · NERC CIP-008 report staged' },
  ], []);
    ...
    <section ref={refCb} className="scene-sticky" data-screen-label="06 Live Scenario" style={{height: '350vh'}}>
      <div className="sticky-inner">
        <div className="scene-label">
          <span className="red">SCENE 06</span> · Live Threat Scenario · Chesterfield
        </div>
  ...
  return (
    <section className="scene" data-screen-label="08 Compliance" style={{padding: '80px 0'}}>
        ...
        <div className="comp-grid">
          <div className="item">
            ...
            <div>
              ...
              <p>Dominion qualifies for FAA Section 2209 restricted-airspace designations over Tier-1 sites. DXD supports the petition, data, and ongoing enforcement coordination with FSDO.</p>
            </div>
          </div>
          <div className="item">
        ...
        <div className="cta-banner">
          <div>
            ...
            <h3 style={{marginTop: 16}}>
              Authorize a <span className="red">90-day</span> pilot at Chesterfield.
            </h3>
            <p>One site. Full sensor stack. DXD-staffed SOC. Outcomes measured against a baseline incident response gap Dominion already knows exists. If it works, we scale to Midlothian and Bremo in Q3.</p>
          </div>
          <div className="meta">
            ...
            <span className="v" style={{fontFamily: 'var(--font-mono)', fontSize: 11, letterSpacing: '0.1em'}}>DXD-CUAS-RCH-2026-04 · r1</span>
          </div>
        </div>
      </div>
      ...
      <div className="end-stamp" style={{marginTop: 80}}>
        ...
        <span>© 2026 Deus X Defense · Unclassified // FOUO · Prepared for Dominion Energy</span>
      </div>
    </section>
  );
}
      ...
      <div className="sources-wrap">
        ...
        <div className="src-footer">
          ...
          <div className="src-stamp">
            ...
            <div className="stamp-v">DXD-CUAS-RCH-2026-04 · r1</div>
            <div className="eyebrow" style={{marginTop: 14}}>Unclassified // FOUO</div>
            <div className="stamp-v" style={{color: 'var(--dxd-red)'}}>Prepared for Dominion Energy</div>
          </div>
        </div>
      </div>
    </section>
