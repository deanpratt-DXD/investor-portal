    ...
    <section id="scene-hero" data-screen-label="01 Title">
      ...
      <div className="hero-wrap">
        <div className="hero-top-meta">
          <span><span className="dash">■</span> DXD-SITREP / DOMINION-CUAS-2026-04</span>
          <span>CLASSIFICATION: UNCLASSIFIED // FOUO</span>
          <span>{t}</span>
        </div>

        <div className="eyebrow">Proposal · Counter-UAS Deployment · Richmond, VA</div>
        ...
        <p className="hero-sub">
          Deus X Defense equips enterprises and critical-infrastructure operators with end-to-end
          drone and operator <strong>detection, situational awareness, mitigation,</strong> and
          <strong> automated incident reporting</strong> to the FAA, FBI, DHS/CISA, and state &amp; local
          law enforcement — a unified counter-UAS perimeter, multi-sensor fusion, and 24/7 manned
          response. FedRAMP and NDAA-compliant from day one.
        </p>

        <div className="hero-stats">
          <div className="s">
            <div className="num">3<span className="red">.</span></div>
            <div className="lbl">Tier-1 Richmond Sites</div>
          </div>
          <div className="s">
        ...
        <div className="hero-cta-row">
          ...
          <span style={{marginLeft: 'auto'}}>Prepared for: Dominion Energy CI Protection</span>
        </div>
      </div>
    </section>
  );
